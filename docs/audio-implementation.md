...
- **>1**: each pulse narrows and a silence gap opens between pulses, for a tighter, more percussive feel. The generator UI (`generate.html`, `generate_bulk.html`) exposes 1 / 1.5 / 2 / 3.
